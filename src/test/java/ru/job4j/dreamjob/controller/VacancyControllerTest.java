...
public class VacancyControllerTest {
    ...
    @Test
    public void whenGetByIdVacancyThenGetVacancyPageForThisVacancy() {
        ...
        var model = new ConcurrentModel();
        var view = vacancyController.getById(model, idArgumentCaptor.capture());
    ...
    @Test
    public void whenGetByIdUnfindedVacancyThenGetErrorPage() {
    ...
    @Test
    public void whenUpdateVacancyIsFalseThenGetErrorPage() {
    ...
    @Test
    public void whenDeleteThenRedirectToVacanciesPage() {
